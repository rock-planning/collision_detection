...
namespace collision_detection
{
    ...
    {
        PrimitiveObject() : primitive_type(collision_detection::CYLINDER),
    ...
    {
        OctreeDebugConfig() : save_octree(false), save_octree_path("./"),
    ...
    {
        CollisionLinkName(const std::string &link_1 = "", const std::string &link_2 = "") : link_1(link_1), link_2(link_2) {}
